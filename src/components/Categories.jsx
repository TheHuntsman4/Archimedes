...
{name:"Horror",gradient:"bg-gradient-to-r from-[#2196F3] to-transparent"},{name:"Investing",gradient:"bg-gradient-to-r from-[#795548] to-transparent"},{name:"Literary",gradient:"bg-gradient-to-r from-[#FFC107] to-transparent"},{name:"Literature",gradient:"bg-gradient-to-r from-[#9E9E9E] to-transparent"},{name:"Manga",gradient:"bg-gradient-to-r from-[#673AB7] to-transparent"},{name:"Media-help",gradient:"bg-gradient-to-r from-[#00ffca] to-transparent"},{name:"Memoirs",gradient:"bg-gradient-to-r from-[#ade4db] to-transparent"},{name:"Mind",gradient:"bg-gradient-to-r from-[#ffebeb] to-transparent"},
{name:"Mystery",gradient:"bg-gradient-to-r from-[#b85c3c] to-transparent"},{name:"Non-Fiction",gradient:"bg-gradient-to-r from-[#78cce2] to-transparent"},{name:"Religion",gradient:"bg-gradient-to-r from-[#78cce2] to-transparent"},{name:"Science",gradient:"bg-gradient-to-r from-[#000000] to-transparent"},{name:"Self",gradient:"bg-gradient-to-r from-gray-600 to-transparent"},{name:"Spirituality",gradient:"bg-gradient-to-r from[#fde2f3] to-transparent"},{name:"Sports",gradient:"bg-gradient-to-r from-[#efbeec] to-transparent"},{name:"Superheroes",gradient:"bg-gradient-to-r from-[#917FB3] to-transparent"},{name:"Technology",gradient:"bg-gradient-to-r from-[#FFF3E2] to-transparent"},
