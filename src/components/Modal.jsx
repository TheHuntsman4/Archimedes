...
export default function Modal({title,author,image,preview,description}) {
  ...
  return (
    <>
      ...
      <div className="grid md:grid-cols-2 grid-cols-1 justify-center align-middle rounded-lg bg-[#202975] p-[2rem] ease-in-out duration-300 hover:scale-[1.15] shadow-2xl shadow-black" onClick={()=>{toggleModal()}}>
